		...
		<div class="container-login100" style="background-image: url('images/bg-02.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="post" action="">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="firstname" placeholder="First name" value=<?php echo $firstname;?>>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
					...
					<div class="container-login100-form-btn m-t-32">
						<button class="login100-form-btn" type="submit" name="submit" value="cancel"style="background: linear-gradient(91deg, #862121 0%, #F12323 14%, #DE3737 24%, #F72D2D 36%, #C10000 70%, #F11919 90%, #DA7E7E 100%);" type="submit" name="submit">
						Cancel
						</button>
